/*
 *
 * Title: return endpoint
 * Description: return endpoint which calculate rental fee
 * Author: Shah Arafat
 * Date: 04-03-2021
 *
 */
...
describe('/api/returns', () => {
  ...
  const exec = () => request(server).post('/api/returns').set('x-auth-token', token).send({ customerId, movieId });
  beforeEach(async () => {
  ...
  test('should return 400 if is already processed', async () => {
